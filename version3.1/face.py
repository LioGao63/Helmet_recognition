...
# # 人脸识别线程
# class Face_thread(QThread, Util, CameraPageWindow):
#     signal_face = pyqtSignal(object)
#
#     def __init__(self, time):
#         super(Face_thread, self).__init__()
#         self.time=time
#
#     def __del__(self):
#         self.wait()
#
#     def __run__(self):
#         face_rec.facerec_pic(self.time)
