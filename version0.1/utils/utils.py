...
def kmeans_targets(path='../coco/trainvalno5k.txt', n=9, img_size=416):  # from utils.utils import *; kmeans_targets()
    # Produces a list of target kmean suitable for use in *.cfg files
    ...
    #     k[i-1], d[i-1] = cluster.vq.kmean(wh, i)  # points, mean distance
    ...
    # Print
    print('kmean anchors (n=%g, img_size=%g, IoU=%.2f/%.2f/%.2f-min/mean/best): ' %
